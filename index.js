...
async function connectToWA() {
  ...
  console.log("Connecting ❤️WARU999❤️");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("❤️WARU999❤️ installed successful ✅");
      console.log("❤️WARU999❤️ connected to whatsapp ✅");

      let up = `❤️WARU999❤️ connected successful ✅`;
      ...
      robin.sendMessage("94724210755@s.whatsapp.net", {
        image: {
          url: `https://raw.githubusercontent.com/Waruna7/bot-help2/refs/heads/main/ChatGPT%20Image%20May%2016%2C%202025%2C%2011_52_58%20AM.png`,
        },
        caption: up1,
...
app.get("/", (req, res) => {
  res.send("hey, ❤️WARU999❤️ started✅");
});
app.listen(port, () =>
